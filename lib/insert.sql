INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "Xanth", 1, 1), (2, "Darwath", 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, "fantasy"), (2, "fantasy");

INSERT INTO authors (id, name) VALUES (1, "Piers Anthony"), (2, "Barbara Hambly");

INSERT INTO books (id, title, year, series_id) VALUES (1, "A Spell for Chameleon", 1977, 1), (2, "The Source of Magic", 1979, 1), (3, "Castle Roogna", 1979, 1), (4, "The Time of the Dark", 1982, 2), (5, "The Walls of Air", 1983, 2), (6, "Third Book", 2005, 2);
